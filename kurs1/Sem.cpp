		...
		case LEX_EQUAL:
			...
			while (lexTable.table[o].lexema != LEX_SEMICOLON)
			{
				if (lexTable.table[o].lexema == LEX_ID || lexTable.table[o].lexema == LEX_LITERAL)
				{
					...
					if (lexTable.table[o].lexema == LEX_ID || lexTable.table[o].lexema == LEX_LITERAL)
					{
						if ((idTable.table[lexTable.table[i - 1].idxTI].iddatatype != idTable.table[lexTable.table[o].idxTI].iddatatype) || (lexTable.table[i - 1].isFunc && lexTable.table[i - 1].isFunc))
						{
